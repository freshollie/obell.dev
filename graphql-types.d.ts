...
export type SitePluginPluginOptionsPluginsPluginOptionsStylesFilterInput = {
  ...
  margin_top?: Maybe<StringQueryOperatorInput>,
...
export type ImageSharpQuery = { allImageSharp: Maybe<{ edges: Array<{ node: { fluid: Maybe<(Pick<ImageSharpFluid, 'originalName'> & GatsbyImageSharpFluidFragment)> } }> }> };
